...
import { GetBestSellers, GetTrendings } from "@/lib/api"
interface Product {
    id: string
    product: string
    product_name: string
...
bg-[#FCFAF7]
  ">
                ...
                <h1 className="font-[var(--font-display)] font-semibold text-[clamp(44px,7vw,78px)] text-[var(--wine-deep)] leading-[1.05]">Bestsellers</h1>
