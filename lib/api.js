...
export async function fetchProducts(collectionName){
    try {
        const response = await fetch(`${baseUrl}/api/Products/${collectionName}`, {
            method: "GET",
            credentials: "include",
        });
...
export async function fetchProductById(productId, collectionName) {
    try {
        const response = await fetch(`${baseUrl}/api/Products/${collectionName}/Product/${productId}`, {
            method: "GET",
            credentials: "include",
        });

        const data = await response.json();
        // backend returns { product: { ... } } — unwrap for convenience
